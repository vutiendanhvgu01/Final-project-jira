...
const CreateTask: React.FC = (props: Props) => {
    ...
    if (editorRef.current) {
        ...
        editorValue.current = (((editorRef.current.getContent()).replace(/(&nbsp;)*/g, "")).replace(/(<p>)*/g, "")).replace(/<(\/)?p[^>]*>/g, "")
    }
                ...
                <form onSubmit={form.handleSubmit} className='form-createTask'>
                    <div className="form-group">
                        ...
                        <div className="wrap-select">
                            <select className='w-100 createTask-select' name='projectId' onChange={form.handleChange} onBlur={form.handleBlur}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="wrap-select">
                            <select className='w-100 createTask-select' name='statusId' onChange={form.handleChange} onBlur={form.handleBlur}>
                        ...
                        <div className="col-6">
                            <div className="priority-task">
                                <div className="form-group">
                                    ...
                                    <div className="wrap-select">
                                        <select className='w-100 createTask-select' name='priorityId' onChange={form.handleChange} onBlur={form.handleBlur}>
                        ...
                        <div className="col-6">
                            <div className="task-type">
                                <div className="form-group">
                                    ...
                                    <div className="wrap-select">
                                        <select className='w-100 createTask-select' name='typeId' onChange={form.handleChange} onBlur={form.handleBlur}>
